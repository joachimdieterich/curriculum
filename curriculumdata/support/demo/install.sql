...
(107, 'menu:readPassword', 'Passwort ändern Seite anzeigen', 'Ability to see password page', 'read', 'menu'),
...
(126, 'menu:readMyPortfolio', 'Menüblock "Mein Portfolio" anzeigen', 'Show menublock "My Portfolio"', 'read', 'curriculum'),
(127, 'menu:readPortfolio', 'Portfolio Menü anzeigen', 'Show Portfoliomenu', 'read', 'curriculum');
