...
if (isset($context)) {
        ...
        case "userFiles":   $extendUploadPath = $USER->id.'/'; //siehe unten                
                            break;
        case "solution":    $extendUploadPath = $curriculum_id.'/'.$terminal_objective_id.'/'.$enabling_objective->id.'/'; //siehe unten                
                            break;  
    ...
    <div id="uf_content" class="floatleft verticalSeperator"> 
        ...
        <div id="div_file_url"  class="floatleft ">
            ...
            if (!isset($_POST['license'])){
                ...
                $select = $_POST['license'];
            } // alle Rechte vorbehalten
            renderSelect('Lizenz:', 'license', $license, $select);
            validate_msg($v_error, 'license'); ?>  
            <?php validate_msg($v_error, 'author');
