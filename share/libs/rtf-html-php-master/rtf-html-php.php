<?php
  ...
  class RtfReader
  {
    ...
    protected function ParseControlSymbol()
    {
      ...
      $parameter = 0;
       /* modified to get line brakes see: http://www.independent-software.com/a-working-rtf-to-html-converter-in-php/#comment-4584 */
      if($symbol == '\'')
      {
        $this->GetChar();
        $parameter = $this->char;
  ...
  class RtfHtml
  {
    ...
    protected function FormatControlSymbol($symbol)
    {
      ...
      /* added to get line brakes see: http://www.independent-software.com/a-working-rtf-to-html-converter-in-php/#comment-4584 */
