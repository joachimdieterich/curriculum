    ...
    <div class="space-top-padding gray-gradient box-shadow ">
       ...
       <!-- <div id="right">
        ...
        <form method='post' action='index.php?action=teacherProfile'>	
            ...
            <p><label>Avatar: </label><input class="inputform" id="myfile" name='avatar' value={$newUserAvatar} readonly  onclick="tb_show('','assets/scripts/libs/modal-upload/uploadframe.php?userID={$my_id}&context=avatar&target=myfile&format=1&multiple=false&placeValuesBeforeTB_=savedValues&TB_iframe=true&width=710&modal=true')" href="#" class="thickbox"/>
            {validate_msg field='avatar'}
                {*<a href="assets/scripts/libs/modal-upload/uploadframe.php?userID={$my_id}&context=avatar&target=myfile&format=1&multiple=false&placeValuesBeforeTB_=savedValues&TB_iframe=true&width=710&modal=true" >Upload</a></p>*}
