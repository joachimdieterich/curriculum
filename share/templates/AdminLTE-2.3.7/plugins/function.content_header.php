...
function smarty_function_content_header($params) {
    ...
    $_html_result = '<section class="content-header">';
        ...
        if (isset($pages)){
                ...
                if (isset($help)){
                    $_html_result .= '<li><i class="fa fa-info" type="button" name="help" onclick="window.open(\''.$help.'\', \'_blank\', \'\');" data-toggle="tooltip" data-placement="left" title="Curriculum-Wiki">></i></li>';
                }
                $_html_result .= '</ol>';
        }
