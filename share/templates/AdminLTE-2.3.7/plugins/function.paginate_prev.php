...
function smarty_function_paginate_prev($params, &$smarty, $bootstrap = false) {
    ...
    if ($bootstrap){
        return $_show ? '<button type="button" class="btn btn-default" onclick="processor(\'config\',\'paginator_item\','.$_item.',{\'paginator\':\''.$_id.'\',\'reload\':\'true\'});"><a class="fa fa-chevron-left"' . $_attrs . '></a></button>' : '';
    } else {
