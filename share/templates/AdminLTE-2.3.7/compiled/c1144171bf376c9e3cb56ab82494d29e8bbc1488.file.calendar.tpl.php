<?php /* Smarty version Smarty-3.0.6, created on 2017-02-08 11:05:39
         compiled from "/Applications/MAMP/htdocs/curriculum/share/templates/AdminLTE-2.3.7/calendar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:948027771589aed73184017-78032003%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1144171bf376c9e3cb56ab82494d29e8bbc1488' => 
    array (
      0 => '/Applications/MAMP/htdocs/curriculum/share/templates/AdminLTE-2.3.7/calendar.tpl',
      1 => 1481916357,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '948027771589aed73184017-78032003',
  'function' => 
  array (
    'validate_msg' => 
    array (
...
<!-- fullCalendar 2.2.5-->
<link rel="stylesheet" href="<?php echo $_smarty_tpl->getVariable('template_url')->value;?>
plugins/fullcalendar/fullcalendar.min.css">
<link rel="stylesheet" href="<?php echo $_smarty_tpl->getVariable('template_url')->value;?>
plugins/fullcalendar/fullcalendar.print.css" media="print">
</head><?php if ($_smarty_tpl->getVariable('page_action')->value=='login'||$_smarty_tpl->getVariable('page_action')->value=='lock'||$_smarty_tpl->getVariable('page_action')->value=='extern'){?><body class="hold-transition <?php if ($_smarty_tpl->getVariable('page_action')->value=='login'||$_smarty_tpl->getVariable('page_action')->value=='extern'){?>login-page<?php }?> <?php if ($_smarty_tpl->getVariable('page_action')->value=='lock'){?>lockscreen<?php }?>" style="background-image: url('<?php echo $_smarty_tpl->getVariable('random_bg')->value;?>
...
$_template->properties['nocache_hash']  = '948027771589aed73184017-78032003';
...
;idleTime = 0;$(document).ready(function () {var idleInterval = setInterval("timerIncrement()", 60000);$(document.getElementById('popup')).attr('class', 'modal');});function timerIncrement() {idleTime = idleTime + 1;if (idleTime === idleMax) {window.location="index.php?action=logout&timout=true";}}</script><?php }?><!-- end Logout - Timer  --><!-- Nyromodal  --><script type="text/javascript">$(function() {$('.nyroModal').nyroModal({callbacks: {beforeShowBg: function(){$('body').css('overflow', 'hidden');},afterHideBg: function(){$('body').css('overflow', '');},afterShowCont: function(nm) {$('.scroll_list').height($('.modal').height()-150);}}});$('#popup_generate').nyroModal();});</script><?php if (isset($_SESSION['FORM']->form)){?><script type="text/javascript"><?php if (isset($_SESSION['FORM']->id)){?><?php if ($_SESSION['FORM']->id!=''){?>$(document).ready(formloader('<?php echo $_SESSION['FORM']->form;?>
...
plugins/fullcalendar/fullcalendar.min.js"></script>
    <script src="<?php echo $_smarty_tpl->getVariable('template_url')->value;?>
plugins/fullcalendar/lang/de.js"></script>
     <!-- Slimscroll -->
    <script src="<?php echo $_smarty_tpl->getVariable('template_url')->value;?>
...
js/app.min.js"></script-->
    <!-- jQuery UI 1.11.4 -->
    <script src="<?php echo $_smarty_tpl->getVariable('template_url')->value;?>
plugins/fullcalendar/jquery-ui.min.js"></script>
    ...
    <script>
      $(function () {
        ...
        $('#calendar').fullCalendar({
          ...
          events: <?php echo $_smarty_tpl->getVariable('events')->value;?>
,
          editable: true,
