<?php /* Smarty version Smarty-3.0.6, created on 2019-01-17 17:07:11
...
jquery.nyroModal/styles/nyroModal.min.css" media="all"> 
<!-- fullCalendar 2.2.5-->
<link rel="stylesheet" href="<?php echo $_smarty_tpl->getVariable('template_url')->value;?>
plugins/fullcalendar/fullcalendar.min.css">
<link rel="stylesheet" href="<?php echo $_smarty_tpl->getVariable('template_url')->value;?>
plugins/fullcalendar/fullcalendar.print.min.css" media="print">
/* <link rel="stylesheet" href="<?php echo $_smarty_tpl->getVariable('template_url')->value;?>
plugins/fullcalendar-scheduler-1.9.2//scheduler.min.css" media="print"> */
</head><?php if (in_array($_smarty_tpl->getVariable('page_action')->value,array('login','lock','extern'))){?><body class="hold-transition <?php if ($_smarty_tpl->getVariable('page_action')->value=='login'||$_smarty_tpl->getVariable('page_action')->value=='extern'){?>login-page<?php }?> <?php if ($_smarty_tpl->getVariable('page_action')->value=='lock'){?>lockscreen<?php }?>" <?php if ($_smarty_tpl->getVariable('cfg_login_wallpaper')->value){?>style="background-image: url('<?php echo $_smarty_tpl->getVariable('random_bg')->value;?>
...
/*    <script src="<?php echo $_smarty_tpl->getVariable('template_url')->value;?>
plugins/fullcalendar-scheduler-1.9.2//scheduler.min.js"></script> */
