<?php /* Smarty version Smarty-3.0.6, created on 2018-09-18 13:05:37
         compiled from "C:\xampp\htdocs\medienkompass\curriculum\share/templates/AdminLTE-2.3.7/userImport.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7813015565ba0dc01b2d6d9-79964985%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '965856f66a68e28c201cbfea60f9c8e7276db778' => 
    array (
      0 => 'C:\\xampp\\htdocs\\medienkompass\\curriculum\\share/templates/AdminLTE-2.3.7/userImport.tpl',
      1 => 1536670001,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '7813015565ba0dc01b2d6d9-79964985',
  'function' => 
  array (
    'validate_msg' => 
    array (
...
<?php if (!is_callable('smarty_function_content_header')) include 'C:\xampp\htdocs\medienkompass\curriculum\share/templates/AdminLTE-2.3.7/plugins\function.content_header.php';
if (!is_callable('smarty_function_html_paginator')) include 'C:\xampp\htdocs\medienkompass\curriculum\share/templates/AdminLTE-2.3.7/plugins\function.html_paginator.php';
if (!is_callable('smarty_modifier_resolve_file_id')) include 'C:\xampp\htdocs\medienkompass\curriculum\share/templates/AdminLTE-2.3.7/plugins\modifier.resolve_file_id.php';
?><!DOCTYPE html>  
...
<?php echo smarty_function_content_header(array('p_title'=>$_smarty_tpl->getVariable('page_title')->value,'pages'=>$_smarty_tpl->getVariable('breadcrumb')->value,'help'=>'http://docs.joachimdieterich.de/index.php?title=Benutzerliste_importieren'),$_smarty_tpl);?>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-7">
                                ...
                                <ul>
                                    ...
                                    <li>Die maximale Dateigröße liegt bei <?php echo $_smarty_tpl->getVariable('filesize')->value;?>
MB und kann im Adminstrationsbereich festgelegt werden.</li>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5">
                                <h4>CSV-Vorlagen</h4>
                                <a class="btn btn-app" href="<?php echo $_smarty_tpl->getVariable('support_path')->value;?>
Vorlage-min.csv"><i class="fa fa-save"></i> Minimal - nur benötigte Felder</a>
                                <a class="btn btn-app" href="<?php echo $_smarty_tpl->getVariable('support_path')->value;?>
Vorlage-max.csv"><i class="fa fa-save"></i> Maximal - alle möglichen Felder</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class=" col-xs-12 col-sm-12 col-md-5 col-lg-5">
                                <p><?php echo Form::input_select('institution_id','Institution',$_smarty_tpl->getVariable('my_institutions')->value,'institution','institution_id',$_smarty_tpl->getVariable('my_institution_id')->value,null,'getMultipleValues([\'group\', this.value, \'group_id\'], [\'group\', this.value, \'group_table\', \'table\']); ');?>
</p>
                                <p><?php echo Form::input_select('role_id','Rolle',$_smarty_tpl->getVariable('roles')->value,'role','id',$_smarty_tpl->getVariable('role_id')->value,null);?>
</p>
                                <p><?php echo Form::input_select('group_id','Lerngruppe',$_smarty_tpl->getVariable('groups')->value,'group','id',null,null);?>
</p>
                                <p><?php echo Form::input_text('delimiter','Trennzeichen',$_smarty_tpl->getVariable('delimiter')->value,null);?>
</p>
                                <p>
                            ...
                            <span id='group_table'><?php echo Render::table($_smarty_tpl->getVariable('group_table_params')->value);?>
</span> 
                            <span id='role_talbe'><?php echo Render::table($_smarty_tpl->getVariable('role_table_params')->value);?>
</span>
                        </div> 
                    </div>
                </form>
        ...
        <?php if (isset($_smarty_tpl->getVariable('nusr_val',null,true,false)->value)){?>
        <div class="col-xs-12">
            <div class="box box-default">
                <div class="box-header with-border">
                ...
                <div class="box-body">
                    <?php echo smarty_function_html_paginator(array('id'=>'newUsersPaginator','title'=>'Importiert'),$_smarty_tpl);?>
...
$_template->properties['nocache_hash']  = '7813015565ba0dc01b2d6d9-79964985';
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_template;?>
<?php /* Smarty version Smarty-3.0.6, created on 2018-09-18 13:05:37
         compiled from "C:\xampp\htdocs\medienkompass\curriculum\share/templates/AdminLTE-2.3.7/menu.tpl" */ ?>
...
<?php /*  End of included template "C:\xampp\htdocs\medienkompass\curriculum\share/templates/AdminLTE-2.3.7/menu.tpl" */ ?>
