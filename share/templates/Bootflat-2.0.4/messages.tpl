...
<div class="row">
  ...
  {if isset($showInbox) || isset($showOutbox)}
   ...
   <div class="panel panel-primary">
      <div class="panel-heading">{if $box eq 'inbox'}Posteingang{else if $box eq 'outbox'}Postausgang{/if}</div>
      <div class="panel-body no-padding" style="height: 600px;overflow:auto">
        <ul class="nav nav-pills nav-stacked">
          {if isset($messages[0])}  
