    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <a href="#" onclick="formloader('preview','help','{$h->id}')">
              <div class="info-box">
                <span class="info-box-icon bg-aqua" style="background: url('../share/accessfile.php?id={$h->file_id}');background-size: cover; background-repeat: no-repeat;"><i class="ion ion-ios-gear-outline"> </i></span>
