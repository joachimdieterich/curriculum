...
{block name=additional_scripts}{$smarty.block.parent}
    ...
    <!-- fullCalendar 2.2.5 -->
    <script src="{$media_url}templates/AdminLTE-2.3.0/plugins/fullcalendar/fullcalendar.min.js"></script>
    <script src="{$media_url}templates/AdminLTE-2.3.0/plugins/fullcalendar/lang/de.js"></script>
     <!-- Slimscroll -->
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="{$media_url}templates/AdminLTE-2.3.0/plugins/fullcalendar/jquery-ui.min.js"></script>
      {literal}
    <script>
      $(function () {
