...
<script src="{$media_url}templates/AdminLTE-2.3.0/plugins/datepicker/bootstrap-datepicker.js"></script>
<script src="{$media_url}templates/AdminLTE-2.3.0/plugins/datepicker/locales/bootstrap-datepicker.de.js"></script>
...
<link rel="stylesheet" href="{$media_url}templates/AdminLTE-2.3.0/plugins/datepicker/datepicker3.css">
