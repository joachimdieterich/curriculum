 ...
 *
 * Info: some changes made in function get_readable_errors()
 * changed $resp[] to $resp[$e['field']]['message'][] to get fieldnames 
 * 
...
class Gump
{
	...
	public function sanitize(array $input, $fields = NULL, $utf8_encode = true){
            ...
            foreach($fields as $field){
                if(!isset($input[$field])){
                    ...
                    if(is_string($value)){
                        if($magic_quotes === TRUE)          { $value = stripslashes($value); }
	...
	public function get_readable_errors($convert_to_string = false, $field_class="field", $error_class="error-message"){
            ...
            foreach($this->errors as $e) {
                    ...
                    switch($e['rule']) {
                            case 'mismatch' :
                                    $resp[$e['field']]['message'][] = "Es gibt keine gültige Filterregel für <span class=\"$field_class\">$field</span>";
                                    break;
                            case 'validate_required':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld wird benötigt.";
                                    break;
                            case 'validate_valid_email':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss eine gültige Emailadresse sein.";
                                    break;
                            case 'validate_max_len':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss kürzer als $param Zeichen sein.";
                                    break;
                            case 'validate_min_len':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss länger als $param Zeichen sein.";
                                    break;
                            case 'validate_exact_len':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss genau $param Zeichen lang sein.";
                                    break;
                            case 'validate_alpha':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld darf nur Buchstaben (a-z) enthalten.";
                                    break;
                            case 'validate_alpha_numeric':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld darf nur Buchstaben und Zahlen enthalten.";
                                    break;
                            case 'validate_alpha_dash':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld darf nur Buchstaben und &amp; enhalten.";
                                    break;
                            case 'validate_numeric':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld darf nur Zahlen enthalten.";
                                    break;
                            case 'validate_integer':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld darf nur ganze Zahlen enthalten.";
                                    break;
                            case 'validate_boolean':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld darf nur den Wert wahr oder falsch enthalten.";
                                    break;
                            case 'validate_float':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld darf nur eine Kommazahl enthalten.";
                                    break;
                            case 'validate_valid_url':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss eine gültige URL enthalten.";
                                    break;
                            case 'validate_url_exists':
                                    $resp[$e['field']]['message'][] = "Die <span class=\"$field_class\">$field</span> URL existiert nicht.";
                                    break;
                            case 'validate_valid_ip':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss eine gültige IP-Adresse enthalten.";
                                    break;
                            case 'validate_valid_cc':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss eine gültige Kreditkartennummer enthalten.";
                                    break;
                            case 'validate_valid_name':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss einen gültigen Namen enthalten.";
                                    break;
                            case 'validate_contains':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld einen der folgenden Werte enthalten: ".implode(', ', $param);
                                    break;
                            case 'validate_containsList':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss einen Wert aus der Liste enthalten.";
                                    break;
                            case 'validate_doesNotContainList':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld enthält einen ungültigen Wert.";
                                    break;
                            case 'validate_street_address':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss eine gültige Straße enthalten.";
                                    break;
                            case 'validate_date':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss ein gültiges Datum enthalten.";
                                    break;
                            case 'validate_min_numeric':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss eine Zahl größer/gleich $param sein.";
                                    break;
                            case 'validate_max_numeric':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss eine Zahl kleiner/gleich $param sein.";
                                    break;
                            case 'validate_starts':
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld muss mit $param beginnen.";
                                    break;
                            default:
                                    $resp[$e['field']]['message'][] = "Das <span class=\"$field_class\">$field</span> Feld enthält einen ungültigen Wert.";				
                    }
	...
	public function get_errors_array($convert_to_string = null){
            ...
            foreach($this->errors as $e) {
                    ...
                    switch($e['rule']) {
                            case 'mismatch' :
                                    $resp[$field] = "Es gibt keine gültige Filterregel für $field";
                                    break;
                            case 'validate_required':
                                    $resp[$field] = "Das $field Feld wird benötigt.";
                                    break;
                            case 'validate_valid_email':
                                    $resp[$field] = "Das $field Feld muss eine gültige Emailadresse sein.";
                                    break;
                            case 'validate_max_len':
                                    $resp[$field] = "Feld muss kürzer als $param Zeichen sein.";
                                    break;
                            case 'validate_min_len':
                                    $resp[$field] = "Das $field Feld muss länger als $param Zeichen sein.";
                                    break;
                            case 'validate_exact_len':
                                    $resp[$field] = "Das $field Feld muss genau $param Zeichen lang sein.";
                                    break;
                            case 'validate_alpha':
                                    $resp[$field] = "Das $field Feld darf nur Buchstaben (a-z) enthalten.";
                                    break;
                            case 'validate_alpha_numeric':
                                    $resp[$field] = "Das $field Feld darf nur Buchstaben und Zahlen enthalten.";
                                    break;
                            case 'validate_alpha_dash':
                                    $resp[$field] = "Das $field Feld darf nur Buchstaben und &amp; enhalten.";
                                    break;
                            case 'validate_numeric':
                                    $resp[$field] = "Das $field Feld darf nur Zahlen enthalten.";
                                    break;
                            case 'validate_integer':
                                    $resp[$field] = "Das $field Feld darf nur ganze Zahlen enthalten.";
                                    break;
                            case 'validate_boolean':
                                    $resp[$field] = "Das $field Feld darf nur den Wert wahr oder falsch enthalten.";
                                    break;
                            case 'validate_float':
                                    $resp[$field] = "Das $field Feld darf nur eine Kommazahl enthalten.";
                                    break;
                            case 'validate_valid_url':
                                    $resp[$field] = "Das $field Feld muss eine gültige URL enthalten.";
                                    break;
                            case 'validate_url_exists':
                                    $resp[$field] = "Die $field URL existiert nicht.";
                                    break;
                            case 'validate_valid_ip':
                                    $resp[$field] = "Das $field Feld muss eine gültige IP-Adresse enthalten.";
                                    break;
                            case 'validate_valid_cc':
                                    $resp[$field] = "Das $field Feld muss eine gültige Kreditkartennummer enthalten.";
                                    break;
                            case 'validate_valid_name':
                                    $resp[$field] = "Das $field Feld muss einen gültigen Namen enthalten.";
                                    break;
                            case 'validate_contains':
                                    $resp[$field] = "Das $field Feld einen der folgenden Werte enthalten: ".implode(', ', $param);
                                    break;
                            case 'validate_street_address':
                                    $resp[$field] = "Das $field Feld muss eine gültige Straße enthalten.";
                                    break;
                            case 'validate_date':
                                    $resp[$field] = "Das $field Feld muss ein gültiges Datum enthalten.";
                                    break;
                            case 'validate_min_numeric':
                                    $resp[$field] = "Das $field Feld muss eine Zahl größer/gleich $param sein.";
                                    break;
                            case 'validate_max_numeric':
                                    $resp[$field] = "Das $field Feld muss eine Zahl kleiner/gleich $param sein.";
                                    break;
                            default:
                                    $resp[$field] = "Das $field Feld ist ungültig.";				
                    }
            }
