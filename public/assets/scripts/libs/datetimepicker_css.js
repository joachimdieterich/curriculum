...
var SpanBorderColor = "hsl(0,0%,70%)";//span border color
var SpanBgColor = "#f2f2f2"; //span background color
var MonthYearColor = "#444"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#013363"; //Background Color in Week header.
var SundayColor = "#a0a0a0"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#a0a0a0"; //Background color of Saturday.
var WeekDayColor = "#afafaf"; //Background color of weekdays.
...
var CalBgColor = "#dfdfdf"; //Background color of Calendar window.
...
var imageFilesPath = "datetimepickeriImages/";
//Configurable parameters end

//use the Month and Weekday in your preferred language.
var MonthName = ["Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"];
var WeekDayName1 = ["Sonntag", "Montag", "Dienstag", "Mittwpch", "Donnerstag", "Freitag", "Samstag"];
